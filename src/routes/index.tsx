		...
		<div className="min-h-screen bg-background text-foreground overflow-x-hidden">
			...
			<main id="main-content">
				...
				>
					...
					<div
						className="absolute inset-0 bg-gradient-to-b from-black/80 via-black/40 to-black/60 pointer-events-none z-10"
				...
				<section className="py-20 px-6 max-w-7xl mx-auto bg-card/40 backdrop-blur-sm border-y border-border/50">
					...
					<p className="text-muted-foreground text-center max-w-xl mx-auto mb-14">
						Únete al servidor en menos de un minuto.
					</p>
					...
					<div className="grid md:grid-cols-3 gap-10 max-w-5xl mx-auto">
						{[
							{ step: "1", title: "Copiar IP", desc: SERVER_IP },
							{
								...
								desc: "Pega el IP en tu la seccion de servidores",
							},
							{
								step: "3",
							...
							<div
								key={i}
								className="group relative text-center p-8 rounded-2xl border border-border/60 bg-card/60 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
							>
				...
				<section id="roles" className="py-24 px-6 max-w-7xl mx-auto">
					...
					<p className="text-muted-foreground text-center max-w-2xl mx-auto mb-16">
						Cada rango desbloquea beneficios exclusivos y ventajas dentro del
						servidor.
					</p>
					...
					<div className="grid md:grid-cols-3 gap-10 max-w-5xl mx-auto">
						{roles.map((role, i) => (
							<div
								key={i}
								className="group relative p-10 rounded-3xl border border-border/50 bg-card/70 shadow-sm overflow-hidden cursor-pointer transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl flex flex-col"
							>
								<div
									className={`absolute inset-0 bg-gradient-to-br ${role.color} opacity-15 group-hover:opacity-25 transition duration-300`}
								/>
								<div
									className={`absolute inset-0 blur-2xl bg-gradient-to-br ${role.color} opacity-0 group-hover:opacity-20 transition duration-300`}
								/>

								<div className="relative z-10 mb-8 text-center">
									{/* Role name — removed bg clip gradient, now solid primary text */}
									<h3 className="text-3xl font-extrabold tracking-tight text-primary drop-shadow-[0_0_8px_rgba(255,255,255,0.12)]">
										{role.name}
									</h3>
								</div>
								...
								<div className="relative z-10 mt-10">
									...
									<button className="w-full py-3 rounded-xl font-semibold text-primary-foreground bg-primary shadow-md hover:shadow-lg transition-all">
										Mejorar
									</button>
								</div>
							</div>
					...
					<div className="grid md:grid-cols-4 sm:grid-cols-2 gap-6 max-w-5xl mx-auto mb-12">
						{socials.map((social, i) => (
							...
							>
								...
								<div
									className="pointer-events-none absolute -top-10 -left-10 w-36 h-36 rounded-full opacity-20 filter blur-2xl"
				...
				<footer className="py-12 px-6 bg-card border-t border-border">
					<div className="max-w-7xl mx-auto text-center text-muted-foreground">
						<p>
							© 2025 Servidor Aqui. Todos los derechos reservados. Minecraft es
